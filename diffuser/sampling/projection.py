...
# Auto-detect best available device (mirrors diffuser/utils/arrays.py logic)
...
class Constraints:
    ...
    def __init__(self, horizon, transition_dim, normalizer=None, device=_DEFAULT_DEVICE):
        self.horizon = horizon
        self.transition_dim = transition_dim
