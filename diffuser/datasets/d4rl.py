...
_sys.path.insert(0, _os.path.join(_os.path.dirname(__file__), '../../d3il'))
...
def sequence_dataset(env, preprocess_fn):
    ...
    if env in MINARI_DATASETS:
        ...
        for episode in episodes_generator:
            ...
            yield episode_data
    elif env in ('avoiding-d3il', 'd3il-avoiding', 'avoiding-synthetic'):
        subdir = 'avoiding_synthetic' if env == 'avoiding-synthetic' else 'avoiding'
        data_directory = f'environments/dataset/data/{subdir}/data'
